...
#[doc(hidden)]
#[unsafe(no_mangle)]
pub static _fltused: i32 = 0i32;

#[cfg(target_family = "windows")]
#[doc(hidden)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn fma() {}
// NOTE(dij): I don't think this symbol is "ran", I can't seem to get it to
// "trigger" so maybe it's fine?
// BUG(dij): Just for tracking in-case it does cause issues.

#[cfg(target_family = "windows")]
#[doc(hidden)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn fmaf() {}
// NOTE(dij): I don't think this symbol is "ran", I can't seem to get it to
// "trigger" so maybe it's fine?
// BUG(dij): Just for tracking in-case it does cause issues.
...
mod inner {
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _allshl(value: i64, positions: i64) -> i64 {
        naked_asm!(
            "cmp  cl,  64
             jnb  3f
             cmp  cl,  32
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _allshr(value: i64, positions: i64) -> i64 {
        naked_asm!(
            "cmp  cl,  64
             jnb  3f
             cmp  cl,  32
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _aullshr(value: u64, positions: u64) -> u64 {
        naked_asm!(
            "cmp  cl,  64
             jnb  3f
             cmp  cl,  32
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _alldiv(dividend: i64, divisor: i64) -> i64 {
        naked_asm!(
            "push edi
             push esi
             push ebx
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _allrem(dividend: i64, divisor: i64) -> i64 {
        naked_asm!(
            "push ebx
             push edi
             xor  edi,                    edi
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _aulldiv(dividend: u64, divisor: u64) -> u64 {
        naked_asm!(
            "push ebx
             push esi
             mov  eax, dword ptr [esp + 0x18]
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _aullrem(dividend: u64, divisor: u64) -> u64 {
        naked_asm!(
            "push ebx
             mov  eax, dword ptr [esp + 0x14]
             or   eax, eax
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _aulldvrm(dividend: u64, divisor: u64) -> u64 {
        naked_asm!(
            "push esi
             mov  eax, dword ptr [esp + 0x14]
             or   eax, eax
    ...
    #[unsafe(naked)]
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn _allmul(multiplier: i64, multiplicand: i64) -> i64 {
        naked_asm!(
            "mov  eax, dword ptr [esp + 0x8]
             mov  ecx, dword ptr [esp + 0x10]
             or   ecx, eax
    ...
    pub unsafe extern "C" fn _alldvrm(dividend: i64, divisor: i64) -> (i64, i64) {
        naked_asm!(
            "push edi
             push esi
             push ebp
